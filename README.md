...
[![Cran Status](http://www.r-pkg.org/badges/version/tidyxl)](https://cran.r-project.org/web/packages/tidyxl/index.html)
...
or install the more experimental [lexl](https://nacnudus.github.io/lexl) package
to run `demo_lexl()` locally.
...
Names are imported with `xlex_names()`.  AKA 'named formulas' and 'defined
