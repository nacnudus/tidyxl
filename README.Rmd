...
![Gif of tidyxl converting cells into a tidy representation of one row per cell](./articles/tidy_xlsx.gif)
...
a free, online cookbook using [tidyxl](https://github.com/nacnudus/tidyxl) and
