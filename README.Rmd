...
![Cran Status](http://www.r-pkg.org/badges/version/tidyxl)
![Cran Downloads](https://cranlogs.r-pkg.org/badges/tidyxl)
...
![iris-screenshot](`r rprojroot::find_package_root_file("vignettes/iris-screenshot.png")`)
...
![styles-screenshot](`r rprojroot::find_package_root_file("vignettes/styles-screenshot.png")`)
